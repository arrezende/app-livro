  ...
  useEffect(() => {
    if (rendition) {
        rendition.themes.register(theme.name, {
            body: { color: theme.fg, background: theme.bg, '-webkit-tap-highlight-color': 'transparent' },
            '::selection': { background: 'rgba(255, 255, 0, 0.3)' },
            'p': { color: theme.fg },
            'h1': { color: theme.fg }, 'h2': { color: theme.fg }, 'h3': { color: theme.fg },
            'span': { color: theme.fg }, 'div': { color: theme.fg },
